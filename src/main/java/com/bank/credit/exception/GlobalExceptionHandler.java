...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorDto> cardNotFoundException() {
		ErrorDto errorDto = new ErrorDto();
		errorDto.setErrorMessage(Constant.CARD_NOT_FOUND);
		errorDto.setErrorStatusCode(HttpStatus.FORBIDDEN.value());
		return ResponseEntity.status(HttpStatus.OK).body(errorDto);
	}
